...
class ChatCommand : CommandExecutor {
    override fun onCommand(
        ...
        if (args.isEmpty()) {
            ...
            Chat.sendMessage(sender, "${Chat.prefix} Your chat mode ${Chat.dash} ${Chat.secondaryColor}${JavaPlugin.getPlugin(Kraftwerk::class.java).profileHandler.getProfile(BsonBinary(sender.uniqueId))!!.chatMode}")
            return true
        }
        JavaPlugin.getPlugin(Kraftwerk::class.java).profileHandler.getProfile(BsonBinary(sender.uniqueId))!!
        if (args[0] == "moles" || args[0] == "mole" || args[0] == "m") {
            ...
            JavaPlugin.getPlugin(Kraftwerk::class.java).profileHandler.getProfile(BsonBinary(sender.uniqueId))!!.chatMode = "MOLES"
            ...
            JavaPlugin.getPlugin(Kraftwerk::class.java).profileHandler.getProfile(BsonBinary(sender.uniqueId))!!.chatMode = "STAFF"
            ...
            JavaPlugin.getPlugin(Kraftwerk::class.java).profileHandler.getProfile(BsonBinary(sender.uniqueId))!!.chatMode = "PUBLIC"
            ...
            JavaPlugin.getPlugin(Kraftwerk::class.java).profileHandler.getProfile(BsonBinary(sender.uniqueId))!!.chatMode = "SPEC"
            ...
            JavaPlugin.getPlugin(Kraftwerk::class.java).profileHandler.getProfile(BsonBinary(sender.uniqueId))!!.chatMode = "TEAM"

...
class ExtendCommand : CommandExecutor {
    override fun onCommand(sender: CommandSender, command: Command, label: String, args: Array<out String>): Boolean {
        ...
        if (args.isEmpty()) {
            Chat.sendMessage(sender, "${Chat.prefix} Usage: ${Chat.secondaryColor}/extend <minutes>&7.")
            return true
        }
        ...
        if (Kraftwerk.instance.opening != null) {
            ...
            Chat.broadcast("${Chat.prefix} The opening timer has been extended for ${Chat.secondaryColor}${args[0]} minutes&7.")
        } else {
